...
from keras.layers.advanced_activations import Permutation
...
#model.add(Activation('relu'))
#model.add(Convolution2D(16,61,3,3)
#model.add(Activation('relu'))
...
print "Training..."
model.fit(X_train, Y_train, nb_epoch=500, batch_size=batch_size)
