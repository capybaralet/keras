...
parser.add_argument("--sf_cost", type=float, dest="sf_cost", default=0.)
...
if sf_cost != 0:
    model.add(ActivityRegularization(sparse_filtering=sf_cost))
...
if not PCA:
    ...
    if not data_augmentation:
        print("Using ZCA preprocessing, but no augmentation")
